...
Route::get( '/downloads/groups/{group:uuid}/final-specifications/{document:uuid}', [DocumentController::class, 'downloadGroupFinalSpecification'])->name('groups.final-specifications.download');
