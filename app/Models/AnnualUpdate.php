...
class AnnualUpdate extends Model
{
    ...
    public function toCsvArray(): array
    {
        $result = [
                ...
                'funding' => $this->getDataOrNull('funding'), // obsolete 2024
                'funding_other_details' => $this->getDataOrNull('funding_other_details'), // obsolete 2024
                'applied_for_funding' => $this->getDataOrNull('applied_for_funding'), // obsolete 2024
                'funding_thoughts' => $this->getDataOrNull('funding_thoughts'), // obsolete 2024
                'external_funding' => $this->getDataOrNull('external_funding'), // new 2024
                'external_funding_details' => $this->getDataOrNull('external_funding_details'), // new 2024
                'external_funding_type' => $this->getDataOrNull('external_funding_type'), // new 2024
                'external_funding_other_details' => $this->getDataOrNull('external_funding_other_details'), // new 2024
                'funding_plans' => $this->getDataOrNull('funding_plans'), // new 2024
                'funding_plans_details' => $this->getDataOrNull('funding_plans_details'), // new 2024
