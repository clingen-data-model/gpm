<template>
    <application-section title="Variant Re-review">
        ...
        <ul class="list-decimal px-6">
            ...
            <li>
                <input-row :disabled="isComplete" vertical type="large-text" :errors="errors.rereview_lp_and_vus_progress" v-model="workingCopy.data.rereview_lp_and_vus_progress" placeholder="Progress...">
                    <template v-slot:label>
            ...
            <li>
                <input-row :disabled="isComplete" vertical type="large-text" :errors="errors.rereview_lb_progress" v-model="workingCopy.data.rereview_lb_progress" placeholder="Progress...">
                    <template v-slot:label>
