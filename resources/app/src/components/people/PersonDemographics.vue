  ...
  <div class="centered-container">
    ...
    <section>
      <form @submit.prevent="addSurvey">
        ...
        <div style="display: flex;">
          <input type="checkbox" id="ethnicity2" name="ethnicity2" value="Asian" class="container"
            v-model="ethnicity2_val">
          <label for="ethnicity2">Asian (For example: Asian Indian, Chinese, Filipino, Japanese, Korean, Vietnamese,
            etc.)</label><br>
        </div>

        <div style="display: flex;">
          <input type="checkbox" id="ethnicity3" name="ethnicity3" value="Black" class="container"
            v-model="ethnicity3_val">
        ...
        <div style="display: flex;">
          <input type="checkbox" id="ethnicity7" name="ethnicity7" value="White" class="container"
            v-model="ethnicity7_val">
...
export default {
  ...
  methods: {
    addSurvey() {
      ...
      //get api to retrieve user record
      getUser(uuid);

      //put api to load updated record
      // updateUser3(uuid, item);

      //success of get without function
      // const response = api.get(`${baseUrl}/${uuid}`)
      // api.put(`${baseUrl}/${uuid}`)
      //this.data = response;
