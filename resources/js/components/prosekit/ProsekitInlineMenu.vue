...
<template>
    <InlinePopover data-testid="inline-menu-main"
        ...
        <Button :pressed="editor.marks.bold.isActive()" :disabled="!editor.commands.toggleBold.canExec()" tooltip="Bold"
        ...
        <Button v-if="editor.commands.addLink.canExec({ href: '' })" :pressed="editor.marks.link.isActive()"
            tooltip="Link" @click="
                () => {
    ...
    <InlinePopover placement="bottom" :default-open="false" :open="linkMenuOpen" data-testid="inline-menu-link"
        ...
        ">
            <input placeholder="Paste the link..." :defaultValue="getCurrentLink(editor.state)"
        ...
        <button v-if="editor.marks.link.isActive()"
