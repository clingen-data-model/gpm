  ...
  <div>
    ...
    >
      ...
      <AppSection id="scope" title="Scope of Work">
        <ScvcepGeneList ref="geneList" :group="group" @update="handleUpdate" />
        <hr>
    ...
    >
      <AppSection id="curationReviewProcess" title="Plans for Ongoing Review and Reanalysis and Discrepancy Resolution">
        <ScvcepOngoingPlansForm @update="handleUpdate" />
      </AppSection>

      <AppSection id="evidenceSummaries" title="Example CIViC Assertions">
        <EvidenceSummaryList />
      </AppSection>
