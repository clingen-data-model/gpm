  ...
  <div>
    <div class="mb-4">
      <input-row
        ...
        :options="[
          {value: 1, label: 'Process #1: Biocurator review followed by SC-VCEP discussion'},
          {value: 2, label: 'Process #2: Paired biocurator/expert review followed by expedited SC-VCEP approval'}
        ]"
        type="radio-group"
        :errors="errors.curation_review_protocol_id"
        :disabled="!canEdit"
        label="SC-VCEP Standardized Review Process"
        vertical
