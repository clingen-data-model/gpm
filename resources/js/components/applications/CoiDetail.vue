  ...
  <div v-if="response">
    ...
    <div class="text-sm response-data">
      ...
      <div v-if="!response.document_uuid" class="response-data">
        <dictionary-row
          :label="response.work_fee_lab.question" :vertical="true"
        ...
        >
          ...
          <dictionary-row
            v-if="response.contributions_to_gd_in_ep.response == 1" :label="response.contributions_to_genes.question"
            :vertical="true"
        ...
        >
          ...
          <dictionary-row
            v-if="response.contributions_to_gd_in_group.response == 1" :label="response.contributions_to_genes.question"
            :vertical="true"
            class="pb-1 mb-1 ml-4"
            label-class="font-bold"
          >
        ...
        >
          ...
          <dictionary-row
            v-if="[1,2].includes(response.independent_efforts.response)" :label="response.independent_efforts_details.question"
            :vertical="true"
        ...
        <dictionary-row
          :label="response.coi.question" :vertical="true"
          class="pb-1 mb-1"
          label-class="font-bold"
        >
          ...
          <dictionary-row
            v-if="[1,2].includes(response.coi.response)" :label="response.coi_details.question"
            :vertical="true"
            class="pb-1 mb-1 ml-4"
            label-class="font-bold"
          >
