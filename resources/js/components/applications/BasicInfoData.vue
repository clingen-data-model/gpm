  ...
  <div>
    ...
    <dictionary-row label-class="font-bold w-40" label="Website URL">
      <a 
        ...
        :href="`https://clinicalgenome.org/affiliation/${group.affiliation_id}`"
        target="ep-website"
      >
        https://clinicalgenome.org/affiliation/{{ group.affiliation_id }}
      </a>
      <span v-else>https://clinicalgenome.org/affiliation/{{ group.affiliation_id || '--' }}</span>
    </dictionary-row>
