  ...
  <div>
    <slot name="heading">
      <div class="flex justify-between py-2">
        ...
        <button v-if="canManage" class="btn btn-xs" @click="initUpload">
          Upload
        </button>
      </div>
    </slot>
    ...
    >
      ...
      <template #cell-actions="{item}">
        <dropdown-menu hideCheveron>
          ...
          <dropdown-item @click="initDownload(item)">
            Download
          </dropdown-item>
          <dropdown-item v-if="canManage" @click="initUpdate(item)">
            Update
          </dropdown-item>
          <dropdown-item v-if="canManage" @click="initDelete(item)">
            Delete
          </dropdown-item>
        </dropdown-menu>
      </template>
      <template #detail="{item}">
        <div class="px-4 pb-4 border">
          ...
          <div v-if="canManage" class="flex space-x-2 pt-2 border-t">                    
            <button class="btn btn-xs" @click="initDownload(item)">
              Download
            </button>
            <button class="btn btn-xs" @click="initUpdate(item)">
              Update
            </button>
            <button class="btn btn-xs red" @click="initDelete(item)">
              Delete
            </button>
          </div>
        </div>
