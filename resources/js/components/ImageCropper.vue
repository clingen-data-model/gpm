  ...
  <div>
      ...
      <popper arrow hover>
        <template #content>
          ...
          <ul class="list-disc pl-6 text-xs">
            ...
            <li>
              Resize the cropped region by clicking on the edges or corners of the cropper and dragging.
            </li>
          ...
          <note class="pl-6 mt-3">
            The cropper must be entirely on the image so you may need to reduce the
            cropped are or zoom out to move the image.
          </note>
        </template>
    ...
    <div class="flex space-x-4">
      ...
      <div>
        <h4>Preview</h4>
        <img
          class="border border-gray-700 overflow-hidden drop-shadow" style="width: 100px; height: 100px"
          :src="previewUrl"
        >
      </div>
    </div>
