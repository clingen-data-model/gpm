...
create or replace view v_profile_demographics as
    select p.id as person_id,
           ...
           case when career_stage_opt_out then null else career_stage end as career_stage,
           case when career_stage_opt_out then null else career_stage_other end as career_stage_other,
           career_stage_opt_out,
